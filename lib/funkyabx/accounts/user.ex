defmodule FunkyABX.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, FunkyABX.Repo, message: "This email is already taken")
    |> unique_constraint(:email)
  end
  ...
  """
  def valid_password?(%FunkyABX.Accounts.User{hashed_password: hashed_password}, password)
